...
export default function ProfessorHome() {
    ...
    const {professor, getAulas, getTarefas, getPublicacoes} = useContext(ProfessorContext);
    ...
    return (
      <View style={styles.container}>
        ...
        >
              ...
              <View style={styles.headerRow}>
                <View style={styles.profileSection}>
                  ...
                  <View style={styles.greetingWrapper}>
                    <Text style={styles.greetingText}>Olá, {professor.nome.split(' ')[0]} 👋</Text>
          ...
          {/* Resumo do dia - Próxima aula e Tarefas pendentes */}
          <Animated.View 
          ...
          >
            ...
            >
              ...
              <View style={styles.flex1}>
                ...
                <Text style={styles.summaryDetail}>Para corrigir</Text>
              </View>
              <Feather name="chevron-right" size={16} color={TEXT_SUB} style={styles.cardChevron} />
            </AnimatedTouchableOpacity>
          </Animated.View>
          ...
          >
            <ActionCard 
              ...
              onPress={() => navigation.navigate('Atividades', { screen: 'CriarAtividade' })}
            />
            <ActionCard 
              icon="book-open" 
              label="Turmas" 
